...
def calculate_sma(client: common.DbClient, stock: common.StockInfo):
    ...
    data = []
    for i in range(len(sma_results[0]["ts"])):
        data.append((i,
                     sma_results[0]["sma"][i],  # sma5
                     sma_results[1]["sma"][i],  # sma20
                     sma_results[2]["sma"][i],  # sma50
                     sma_results[3]["sma"][i],  # sma120
                     sma_results[4]["sma"][i],  # sma250
                     stock.symbol,
                     sma_results[0]["ts"][i]  # ts
                     ))
